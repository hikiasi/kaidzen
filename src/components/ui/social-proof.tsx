...
const stats = [
  ...
  },
  {
    icon: TrendingUp,
    label: '98%',
    description: 'клиентов остаются на поддержке',
    color: 'from-green-500 to-green-600',
  },
...
const certificates = [
  ...
  {
    name: 'Сертифицированный разработчик',
    icon: CheckCircle,
    color: 'from-green-500 to-green-600',
  },
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            За 12 лет работы мы помогли сотням компаний автоматизировать бизнес-процессы. Наши
            клиенты - это успешные предприятия, которые ценят качество и результат.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Наши клиенты</h3>
            ...
            {clients.map((client, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${client.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
            ...
            {certificates.map((cert, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 text-center">
                  <div
                    className={`w-20 h-20 bg-gradient-to-r ${cert.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white text-center max-w-4xl mx-auto shadow-2xl">
            ...
            <p className="text-xl mb-8 opacity-90">
              &ldquo;Кайдзен-софт помог нам автоматизировать производство и сократить затраты на
              30%. Команда работает профессионально и всегда на связи.&rdquo;
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                ...
                <div className="opacity-80">Директор ООО &ldquo;МеталлПром&rdquo;</div>
              </div>
            </div>
          </div>
        </motion.div>
