          ...
          <div className="space-y-6 text-sm text-gray-700">
            <section>
              ...
              <p className="mb-3">
                ...
                информации о физических лицах (далее — «Пользователи»), пользующихся услугами ООО
                «Кайдзен-софт» (далее — «Компания»).
              </p>
              <p>
                Компания обязуется соблюдать конфиденциальность персональных данных и обеспечивать
            ...
            <section>
              ...
              <p className="mb-3">
                ...
                автоматизации, так и без их использования. Компания принимает необходимые правовые,
            ...
            <section>
              ...
              <p>
                ...
                целей обработки, если иной срок не предусмотрен договором или законодательством РФ.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Компания применяет технические и организационные меры для обеспечения безопасности
            ...
            <section>
              ...
              <p className="mb-3">По вопросам обработки персональных данных можно обращаться:</p>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p>
                  <strong>ООО «Кайдзен-софт»</strong>
                </p>
            ...
            <section>
              ...
              <p>
                ...
                конфиденциальности. Актуальная версия размещается на официальном сайте компании.
              </p>
            </section>
