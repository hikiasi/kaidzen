...
const fullCaseData = {
  1: {
    challenge:
      'Российско-бельгийское предприятие Velden Carpets столкнулось с критической проблемой: складские остатки не соответствовали учетным данным на 2.8 млн рублей. Это приводило к срывам поставок, недовольству клиентов и финансовым потерям.',
    approach: [
  ...
  2: {
    challenge:
      "Сеть магазинов 'Суперцены' с 22 точками продаж тратила 8 часов ежедневно на ручное распределение товаров. Это приводило к кассовым разрывам и появлению неликвидных остатков.",
    approach: [
  ...
  3: {
    challenge:
      'Производственная компания МеталлПром не знала реальную себестоимость продукции, что приводило к убыточным сделкам и неэффективному планированию производства.',
    approach: [
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              {fullData?.challenge || caseStudy.problem}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {(
                fullData?.outcomes ||
                caseStudy.results.map((r) => `${r.metric}: ${r.value} ${r.detail}`)
              ).map((result, index) => (
                <motion.div
                  key={index}
          ...
          {fullData?.testimonial && (
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
              <div className="flex items-start gap-4">
                <div className="text-4xl text-blue-500">&ldquo;</div>
                <div>
